...
/** dst = rand() [a:b] */
double dsca_random_range(double a, double b) {
    return a + (b-a) * dsca_random();
}

/** dst = mean +- amplitude * rand() */
double dsca_random_noise(double mean, double amplitude) {
    return mean - amplitude + 2 * amplitude * dsca_random();
}

/** dst = mean +- sigma * normalized_rand() */
double dsca_random_normal(double mean, double sigma) {
    double u1, u2;
    do {
        u1 = dsca_random();
...
/** dst = rand() [a:b] */
void dvecN_random_range_dvec(double *dst, const double *a, const double *b, int n) {
    for(int i=0; i<n; i++) {
...
/** dst = mean +- amplitude * rand() */
void dvecN_random_noise_dvec(double *dst, const double *mean, const double *amplitude, int n) {
    for(int i=0; i<n; i++) {
...
/** dst = mean +- sigma * normalized_rand() */
void dvecN_random_normal_dvec(double *dst, const double *mean, const double *sigma, int n) {
    for(int i=0; i<n; i++) {
...
/** dst = rand() [a:b] */
dvec2 dvec2_random_range(double a, double b) {
    dvec2 res;
...
/** dst = rand() [a:b] */
dvec2 dvec2_random_range_dvec(dvec2 a, dvec2 b) {
    dvec2 res;
...
/** dst = rand() [a:b] */
dvec2 dvec2_random_range_dvec_v(const double *a, const double *b) {
    return dvec2_random_range_dvec(DVec2(a), DVec2(b));
}

/** dst = mean +- amplitude * rand() */
dvec2 dvec2_random_noise(double mean, double amplitude) {
    dvec2 res;
...
/** dst = mean +- amplitude * rand() */
dvec2 dvec2_random_noise_dvec(dvec2 mean, dvec2 amplitude) {
    dvec2 res;
...
/** dst = mean +- amplitude * rand() */
dvec2 dvec2_random_noise_dvec_v(const double *mean, const double *amplitude) {
    return dvec2_random_noise_dvec(DVec2(mean), DVec2(amplitude));
}

/** dst = mean +- sigma * normalized_rand() */
dvec2 dvec2_random_normal(double mean, double sigma) {
    dvec2 res;
...
/** dst = mean +- sigma * normalized_rand() */
dvec2 dvec2_random_normal_dvec(dvec2 mean, dvec2 sigma) {
    dvec2 res;
...
/** dst = mean +- sigma * normalized_rand() */
dvec2 dvec2_random_normal_dvec_v(const double *mean, const double *sigma) {
...
/** dst = rand() [a:b] */
dvec3 dvec3_random_range(double a, double b) {
    dvec3 res;
...
/** dst = rand() [a:b] */
dvec3 dvec3_random_range_dvec(dvec3 a, dvec3 b) {
    dvec3 res;
...
/** dst = rand() [a:b] */
dvec3 dvec3_random_range_dvec_v(const double *a, const double *b) {
    return dvec3_random_range_dvec(DVec3(a), DVec3(b));
}

/** dst = mean +- amplitude * rand() */
dvec3 dvec3_random_noise(double mean, double amplitude) {
    dvec3 res;
...
/** dst = mean +- amplitude * rand() */
dvec3 dvec3_random_noise_dvec(dvec3 mean, dvec3 amplitude) {
    dvec3 res;
...
/** dst = mean +- amplitude * rand() */
dvec3 dvec3_random_noise_dvec_v(const double *mean, const double *amplitude) {
    return dvec3_random_noise_dvec(DVec3(mean), DVec3(amplitude));
}

/** dst = mean +- sigma * normalized_rand() */
dvec3 dvec3_random_normal(double mean, double sigma) {
    dvec3 res;
...
/** dst = mean +- sigma * normalized_rand() */
dvec3 dvec3_random_normal_dvec(dvec3 mean, dvec3 sigma) {
    dvec3 res;
...
/** dst = mean +- sigma * normalized_rand() */
dvec3 dvec3_random_normal_dvec_v(const double *mean, const double *sigma) {
...
/** dst = rand() [a:b] */
dvec4 dvec4_random_range(double a, double b) {
    dvec4 res;
...
/** dst = rand() [a:b] */
dvec4 dvec4_random_range_dvec(dvec4 a, dvec4 b) {
    dvec4 res;
...
/** dst = rand() [a:b] */
dvec4 dvec4_random_range_dvec_v(const double *a, const double *b) {
    return dvec4_random_range_dvec(DVec4(a), DVec4(b));
}

/** dst = mean +- amplitude * rand() */
dvec4 dvec4_random_noise(double mean, double amplitude) {
    dvec4 res;
...
/** dst = mean +- amplitude * rand() */
dvec4 dvec4_random_noise_dvec(dvec4 mean, dvec4 amplitude) {
    dvec4 res;
...
/** dst = mean +- amplitude * rand() */
dvec4 dvec4_random_noise_dvec_v(const double *mean, const double *amplitude) {
    return dvec4_random_noise_dvec(DVec4(mean), DVec4(amplitude));
}

/** dst = mean +- sigma * normalized_rand() */
dvec4 dvec4_random_normal(double mean, double sigma) {
    dvec4 res;
...
/** dst = mean +- sigma * normalized_rand() */
dvec4 dvec4_random_normal_dvec(dvec4 mean, dvec4 sigma) {
    dvec4 res;
...
/** dst = mean +- sigma * normalized_rand() */
dvec4 dvec4_random_normal_dvec_v(const double *mean, const double *sigma) {
