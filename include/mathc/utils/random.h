...
/** dst = rand() [a:b] */
float sca_random_range(float a, float b) {
    return a + (b-a) * sca_random();
}

/** dst = mean +- amplitude * rand() */
float sca_random_noise(float mean, float amplitude) {
    return mean - amplitude + 2 * amplitude * sca_random();
}

/** dst = mean +- sigma * normalized_rand() */
float sca_random_normal(float mean, float sigma) {
    float u1, u2;
    do {
        u1 = sca_random();
...
/** dst = rand() [a:b] */
void vecN_random_range_vec(float *dst, const float *a, const float *b, int n) {
    for(int i=0; i<n; i++) {
...
/** dst = mean +- amplitude * rand() */
void vecN_random_noise_vec(float *dst, const float *mean, const float *amplitude, int n) {
    for(int i=0; i<n; i++) {
...
/** dst = mean +- sigma * normalized_rand() */
void vecN_random_normal_vec(float *dst, const float *mean, const float *sigma, int n) {
    for(int i=0; i<n; i++) {
...
/** dst = rand() [a:b] */
vec2 vec2_random_range(float a, float b) {
    vec2 res;
...
/** dst = rand() [a:b] */
vec2 vec2_random_range_vec(vec2 a, vec2 b) {
    vec2 res;
...
/** dst = rand() [a:b] */
vec2 vec2_random_range_vec_v(const float *a, const float *b) {
    return vec2_random_range_vec(Vec2(a), Vec2(b));
}

/** dst = mean +- amplitude * rand() */
vec2 vec2_random_noise(float mean, float amplitude) {
    vec2 res;
...
/** dst = mean +- amplitude * rand() */
vec2 vec2_random_noise_vec(vec2 mean, vec2 amplitude) {
    vec2 res;
...
/** dst = mean +- amplitude * rand() */
vec2 vec2_random_noise_vec_v(const float *mean, const float *amplitude) {
    return vec2_random_noise_vec(Vec2(mean), Vec2(amplitude));
}

/** dst = mean +- sigma * normalized_rand() */
vec2 vec2_random_normal(float mean, float sigma) {
    vec2 res;
...
/** dst = mean +- sigma * normalized_rand() */
vec2 vec2_random_normal_vec(vec2 mean, vec2 sigma) {
    vec2 res;
...
/** dst = mean +- sigma * normalized_rand() */
vec2 vec2_random_normal_vec_v(const float *mean, const float *sigma) {
...
/** dst = rand() [a:b] */
vec3 vec3_random_range(float a, float b) {
    vec3 res;
...
/** dst = rand() [a:b] */
vec3 vec3_random_range_vec(vec3 a, vec3 b) {
    vec3 res;
...
/** dst = rand() [a:b] */
vec3 vec3_random_range_vec_v(const float *a, const float *b) {
    return vec3_random_range_vec(Vec3(a), Vec3(b));
}

/** dst = mean +- amplitude * rand() */
vec3 vec3_random_noise(float mean, float amplitude) {
    vec3 res;
...
/** dst = mean +- amplitude * rand() */
vec3 vec3_random_noise_vec(vec3 mean, vec3 amplitude) {
    vec3 res;
...
/** dst = mean +- amplitude * rand() */
vec3 vec3_random_noise_vec_v(const float *mean, const float *amplitude) {
    return vec3_random_noise_vec(Vec3(mean), Vec3(amplitude));
}

/** dst = mean +- sigma * normalized_rand() */
vec3 vec3_random_normal(float mean, float sigma) {
    vec3 res;
...
/** dst = mean +- sigma * normalized_rand() */
vec3 vec3_random_normal_vec(vec3 mean, vec3 sigma) {
    vec3 res;
...
/** dst = mean +- sigma * normalized_rand() */
vec3 vec3_random_normal_vec_v(const float *mean, const float *sigma) {
...
/** dst = rand() [a:b] */
vec4 vec4_random_range(float a, float b) {
    vec4 res;
...
/** dst = rand() [a:b] */
vec4 vec4_random_range_vec(vec4 a, vec4 b) {
    vec4 res;
...
/** dst = rand() [a:b] */
vec4 vec4_random_range_vec_v(const float *a, const float *b) {
    return vec4_random_range_vec(Vec4(a), Vec4(b));
}

/** dst = mean +- amplitude * rand() */
vec4 vec4_random_noise(float mean, float amplitude) {
    vec4 res;
...
/** dst = mean +- amplitude * rand() */
vec4 vec4_random_noise_vec(vec4 mean, vec4 amplitude) {
    vec4 res;
...
/** dst = mean +- amplitude * rand() */
vec4 vec4_random_noise_vec_v(const float *mean, const float *amplitude) {
    return vec4_random_noise_vec(Vec4(mean), Vec4(amplitude));
}

/** dst = mean +- sigma * normalized_rand() */
vec4 vec4_random_normal(float mean, float sigma) {
    vec4 res;
...
/** dst = mean +- sigma * normalized_rand() */
vec4 vec4_random_normal_vec(vec4 mean, vec4 sigma) {
    vec4 res;
...
/** dst = mean +- sigma * normalized_rand() */
vec4 vec4_random_normal_vec_v(const float *mean, const float *sigma) {
